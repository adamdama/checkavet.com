 ...
 * @since		1.6
 */
class CheckavetViewVet extends JView
{
	protected $form;
	protected $item;
	protected $state;
	...
	protected function addToolbar()
	{
		...
		if ($isNew) {
			...
			JToolBarHelper::cancel('vet.cancel');
		}
		else {
			...
			//if ($canDo->get('core.create')) {
				JToolBarHelper::save2copy('vet.save2copy');
			//}

			JToolBarHelper::cancel('vet.cancel', 'JTOOLBAR_CLOSE');
		}
