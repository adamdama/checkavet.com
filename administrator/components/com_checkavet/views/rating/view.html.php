...
/**
 * View to edit an rating.
 *
 * @package		Joomla.Administrator
 * @subpackage	com_checkavet
 * @since		1.6
 */
class CheckavetViewRating extends JView
{
	protected $form;
	protected $item;
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_CHECKAVET_PAGE_'.($checkedOut ? 'VIEW_RATING' : ($isNew ? 'ADD_RATING' : 'EDIT_RATING'))), 'rating-add.png');
		...
		//JToolBarHelper::help('JHELP_CHECKAVET_RATING_MANAGER_EDIT');
	}
}
