 ...
 * @since       11.1
 */
class JTablePetservices extends JTable
{
	/**
	 * Constructor
	 *
	...
	{
		parent::__construct('#__checkavet_petservices', 'id', $db);
	}
	...
	/*protected function _getAssetParentId($table = null, $id = null)
	{
		...
		// This is a petservice under a category.
		if ($this->catid) {
	...
	/*public function bind($array, $ignore = '')
	{
		...
		if (isset($array['petservicetext'])) {
			...
			$tagPos	= preg_match($pattern, $array['petservicetext']);

			if ($tagPos == 0) {
				$this->introtext	= $array['petservicetext'];
				$this->petservicetext         = '';
			} else {
				list($this->introtext, $this->petservicetext) = preg_split($pattern, $array['petservicetext'], 2);
			}
		}
	...
	public function store($updateNulls = false)
	{
		...
		if ($this->id) {
			...
			// New petservice. An petservice created and created_by field can be set by the user,
